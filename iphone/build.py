...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','tv.harukaze.ti.webview.useragent.ios.js')
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','tv.harukaze.ti.webview.useragent.ios.js']
